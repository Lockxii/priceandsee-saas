    ...
    <section className="relative pt-32 pb-32 w-full flex flex-col items-center border-b border-[#ebebeb]/60">
      ...
      <div className="relative z-10 text-center max-w-[1000px] px-6 mx-auto flex flex-col items-center">
        ...
        <motion.h1 
          ...
          className="text-[40px] sm:text-[48px] md:text-[50px] lg:text-[56px] font-[800] tracking-tight leading-[1.12] mb-8 relative z-10"
        >
          <span className="text-black relative inline-block md:whitespace-nowrap pr-2">
            ...
            <span className="relative inline-block">
              ...
              <motion.span 
                ...
                className="absolute -bottom-5 left-1/2 -translate-x-1/2 md:-bottom-6 inline-flex items-center justify-center bg-gradient-to-br from-[#ff690c] to-[#e55e0b] text-white px-3 py-1 md:px-4 md:py-1.5 rounded-[8px] text-[10px] md:text-[13px] font-bold tracking-widest uppercase shadow-[0_4px_14px_rgba(255,105,12,0.4)] border border-white/20 pointer-events-none select-none z-20 whitespace-nowrap"
                style={{ rotate: '-2deg' }}
              >
                &amp; EN TEMPS-RÉEL
              </motion.span>
