...
export function SettingsModalRenderer({ user, updateProfileAction }: { user: any, updateProfileAction: any }) {
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="bg-[#fffaf6] w-full max-w-3xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95 duration-200">
        <div className="px-8 py-5 border-b border-[#f1ded1] flex justify-between items-center bg-white">
        ...
        <div className="p-8 overflow-auto space-y-8 flex-1">
