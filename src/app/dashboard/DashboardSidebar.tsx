    ...
    <Link
      ...
      className={`dashboard-list-row flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all ${
        active
          ...
          : "text-[#5b4638] font-medium hover:bg-[#fffdfb] hover:text-[#24170f]"
      }`}
    >
...
export function DashboardSidebar({ footer }: { footer?: ReactNode }) {
  return (
    <aside className="hidden sm:flex w-[272px] shrink-0 bg-white border-r border-[var(--dash-border)] flex-col shadow-[12px_0_40px_-34px_rgba(36,23,15,0.35)]">
