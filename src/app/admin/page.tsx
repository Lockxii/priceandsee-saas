...
import { Activity, BarChart3, Link as LinkIcon, Search, Shield, Users } from "lucide-react";
  ...
  return (
    <>
      <header className="h-16 flex items-center justify-between px-8 bg-white border-b border-[#f1ded1]">
        ...
        <Link href="/admin/analytics" className="inline-flex h-10 items-center gap-2 rounded-xl bg-[#17120f] px-4 text-sm font-bold text-white shadow-[0_12px_26px_-16px_rgba(0,0,0,0.8)] hover:bg-black">
            ...
            {statCards.map((stat) => (
              <div key={stat.label} className="rounded-[16px] border border-[#e8ded6] bg-white p-5">
                <div className="mb-6 flex items-center justify-between">
                  <div className="flex h-9 w-9 items-center justify-center rounded-lg border border-[#e8ded6] bg-white"><stat.icon className="h-4 w-4" /></div>
